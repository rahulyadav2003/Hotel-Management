...
<body>
    ...
    <div class="frontpage">
        ...
        <div class="navbar">
            ...
            <ul id="navbarmain">
                ...
                <li>
                    <a href="./admin-panel/index.php">Admin</a>
                </li>
            </ul>
    ...
    <div class="about" id="about">
        ...
        <div class="aboutpic" id="r3"><img src="img/about.jpg" alt="">
            <div class="adesc">
                Welcome to [Hotel Name], where timeless traditions meet modern comfort. Our authentic Indian hospitality invites you to immerse yourself in the rich tapestry of our culture. Indulge in tantalizing flavors, relax in luxurious accommodations,.
                <br><br>  and discover the vibrant spirit of India, all within the welcoming embrace of [Hotel Name]
                <div class="btn">
                    <a href="" target="_blank"><button id="aboutbtn">Explore us</button></a>
                </div>
            </div>
        </div>
    </div>
